...
Copy of my issue in nested_form repo (https://github.com/ryanb/nested_form/issues)
...
One can get an application at ....... and try to run `/libraries/new` (this app is rails 4.0.rc1 but nested_form on rails 3 experience exactly the same problem) and try it with book title in form or without. You can just remove `=` signs not to render these fields:
